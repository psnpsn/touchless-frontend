...
import { OutlineData } from 'src/app/@core/data/handwashAnalyticsData';
import { LayoutService } from 'src/app/@core/utils/layout.service';
import * as echarts from 'echarts/lib/echarts';

@Component({
  selector: 'app-handwash-analytics-chart',
  templateUrl: './handwash-analytics-chart.component.html',
  styleUrls: ['./handwash-analytics-chart.component.scss']
})
export class HandwashAnalyticsChartComponent implements OnDestroy {
